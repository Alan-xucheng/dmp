...
$mimes = array(	'hqx'	=>	'application/mac-binhex40',
				...
				'mpga'	=>	'audio/mpeg',
				'mp2'	=>	'audio/mpeg',
				'mp3'	=>	array('audio/mpeg', 'audio/mpg','audio/mp34','audio/mp3'),
				'mp4'	=>	array('video/quicktime','video/mp4'),	
				'aif'	=>	'audio/x-aiff',
				'aiff'	=>	'audio/x-aiff',
				'aifc'	=>	'audio/x-aiff',
				...
				'eml'	=>	'message/rfc822',
				'apk'	=>	array('application/x-www-form-urlencoded',
					'application/vnd.android.package-archive',
					'application/x-zip',
					'application/zip',
					'application/x-zip-compressed',
					'application/octet-stream'),
				'ipa'	=>	array('application/octet-stream',
